...
public class ControlHomeAdmin {
    private HomeAdmin<Notificacion, Ciudadano, Proyecto> vista;
    ...
    public ControlHomeAdmin(Ventana<Notificacion, Proyecto, Ciudadano> frame, Aplicacion modelo, ControlPerfil cPerfil) {
        this.frame = frame;
